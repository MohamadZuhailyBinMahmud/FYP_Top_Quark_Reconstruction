...
def chisquared(perms,JetSel):
    ...
    eventChiSave.append(combinationChiSve[0][address2])
    eventChiSave.append(combinationChiSve[1][address2])
    eventChiSave.append(combinationChiSve[2][address2])
    eventChiSave.append(combinationChiSve[3][address2])
